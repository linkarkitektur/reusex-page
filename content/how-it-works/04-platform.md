...
steps:
  - label: ""
    ...
    heading: "Data accessible on the platform"
    body: "Users access the 3D model, segmented components, inventories, and documentation in one shared dashboard—so municipalities, owners, and consultants work from the same dataset."
  - label: ""
